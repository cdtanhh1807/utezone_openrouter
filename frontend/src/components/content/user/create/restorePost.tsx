...
const RestorePost = ({ isOpen, onClose, post, onPostUpdated }: EditPostProps) => {
  ...
  const handleUpdatePost = async () => {
    ...
    try {
      ...
      ToastService.success("Khôi phục bài viết thành công!");
      onClose();
      onPostUpdated?.();
    } catch (err) {
      console.error(err);
      ToastService.error("Đã xảy ra lỗi khi khôi phục bài viết.");
    }
        ...
        >
          ...
          <div className="edit-right">
            ...
            <button
              ...
              disabled={loading}
            >
              {loading ? "Đang cập nhật..." : "Khôi phục"}
            </button>
          </div>
        </motion.div>
      </motion.div>
