...
class CrawlToPostConverter:
    ...
    def map_category(self, crawl_category: str) -> str:
        ...
        category_mapping = {
            "Hoạt động": "CÔNG NGHỆ HÓA HỌC VÀ THỰC PHẨM",
            "Thông báo": "CÔNG NGHỆ HÓA HỌC VÀ THỰC PHẨM",
            "Tuyển dụng": "CÔNG NGHỆ HÓA HỌC VÀ THỰC PHẨM",
        }
    ...
    async def convert(self, crawl_doc: Dict[str, Any]) -> AddPostRequest:
        ...
        if not categories:
            categories = ["CÔNG NGHỆ HÓA HỌC VÀ THỰC PHẨM"]
        ...
        return AddPostRequest(
            ...
            status="active",
            createdBy="fcft.hcmute@utezone.com",
            category=categories,
            pollData=None,
