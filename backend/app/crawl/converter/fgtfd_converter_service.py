...
class CrawlToPostConverter:
    ...
    def map_category(self, crawl_category: str) -> str:
        ...
        category_mapping = {
            "Sinh hoạt": "THỜI TRANG VÀ DU LỊCH",
            "Thông báo": "THỜI TRANG VÀ DU LỊCH",
            "Tuyển dụng": "THỜI TRANG VÀ DU LỊCH",
        }
    ...
    async def convert(self, crawl_doc: Dict[str, Any]) -> AddPostRequest:
        ...
        if not categories:
            categories = ["THỜI TRANG VÀ DU LỊCH"]
        ...
        return AddPostRequest(
            ...
            status="active",
            createdBy="fgtfd.hcmute@utezone.com",
            category=categories,
            pollData=None,
