...
class CrawlToPostConverter:
    ...
    def map_category(self, crawl_category: str) -> str:
        ...
        category_mapping = {
            "Sự kiện": "VIỆN SƯ PHẠM KỸ THUẬT",
            "Bồi dưỡng": "VIỆN SƯ PHẠM KỸ THUẬT",
            "Hoạt động": "VIỆN SƯ PHẠM KỸ THUẬT",
        }
    ...
    async def convert(self, crawl_doc: Dict[str, Any]) -> AddPostRequest:
        ...
        if not categories:
            categories = ["VIỆN SƯ PHẠM KỸ THUẬT"]
        ...
        return AddPostRequest(
            ...
            status="active",
            createdBy="ite.hcmute@utezone.com",
            category=categories,
            pollData=None,
