...
from crawl.importdata.fme.fme_import import import_single_article
...
class FMEPlaywrightCrawler:
    BASE_URL = "https://fme.hcmute.edu.vn"
    
    CATEGORIES = {
        "thong-tin": {
            "name": "Thông tin",
            "url": "https://fme.hcmute.edu.vn/TopicId/b9bc157c-72d0-4da8-94e3-3edd93221b6d/thong-tin-tong-hop"
        },
        "hoat-dong": {
            "name": "Hoạt động", 
            "url": "https://fme.hcmute.edu.vn/TopicId/c00e7cc9-68a3-4014-946d-e80a9df7237a/cac-hoat-dong-noi-bat"
        },
        "tuyen-dung": {
            "name": "Tuyển dụng",
            "url": "https://fme.hcmute.edu.vn/TopicId/9ee6abea-7ba7-4bde-aced-5a77b7f1d074/tuyen-dung-thuc-tap"
        }
    }
    ...
    async def save(self, articles, output_file="crawl/output/fme_output/articles.json"):
        import os
        import json
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="FME.HCMUTE Crawler")
    parser.add_argument("-c", "--category", 
                       choices=['thong-tin', 'hoat-dong', 'tuyen-dung', 'all'],
                       default='all')
