...
from crawl.importdata.fgam.fgam_import import import_single_article
...
class FGAMPlaywrightCrawler:
    BASE_URL = "https://fgam.hcmute.edu.vn"
    
    CATEGORIES = {
        "tin-moi": {
            "name": "Tin mới",
            "url": "https://fgam.hcmute.edu.vn/TopicId/e0930d82-7dcf-4d59-b5ee-cce4a6ee88b7/tin-moi"
        },
        "thong-bao": {
            "name": "Thông báo", 
            "url": "https://fgam.hcmute.edu.vn/TopicId/cb731679-6e47-45ca-a644-4133e35cc24b/thong-bao"
        },
        "tuyen-dung": {
            "name": "Tuyển dụng",
            "url": "https://fgam.hcmute.edu.vn/TopicId/180c50fa-7dab-44e6-a86d-386e7e0ca3b7/doanh-nghiep-tuyen-dung"
        }
    }
    ...
    async def save(self, articles, output_file="crawl/output/fgam_output/articles.json"):
        import os
        import json
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="FGAM.HCMUTE Crawler")
    parser.add_argument("-c", "--category", 
                       choices=['tin-moi', 'thong-bao', 'tuyen-dung', 'all'],
                       default='all')
