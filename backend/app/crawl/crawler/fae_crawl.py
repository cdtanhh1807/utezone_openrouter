...
from crawl.importdata.fae.fae_import import import_single_article
...
class FAEPlaywrightCrawler:
    BASE_URL = "https://fae.hcmute.edu.vn"
    
    CATEGORIES = {
        "tin-tuc": {
            "name": "Tin tức",
            "url": "https://fae.hcmute.edu.vn/TopicId/71b5c212-2a32-46dd-a3cb-0387df8454bf/tin-tuc-su-kien"
        },
        "thong-bao": {
            "name": "Thông báo", 
            "url": "https://fae.hcmute.edu.vn/TopicId/cb45c163-7586-43b9-96ee-2ca05c51fab5/thong-bao"
        },
        "hoc-vu": {
            "name": "Học vụ",
            "url": "https://fae.hcmute.edu.vn/TopicId/b927055b-e06a-468d-a3d9-27fbbe9d9bf0/hoc-vu"
        }
    }
    ...
    async def save(self, articles, output_file="crawl/output/fae_output/articles.json"):
        import os
        import json
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="FAE.HCMUTE Crawler")
    parser.add_argument("-c", "--category", 
                       choices=['tin-tuc', 'thong-bao', 'hoc-vu', 'all'],
                       default='all')
