...
from crawl.importdata.feee.feee_import import import_single_article
...
class FEEEPlaywrightCrawler:
    BASE_URL = "https://feee.hcmute.edu.vn"
    
    CATEGORIES = {
        "tin-tuc": {
            "name": "Tin tức",
            "url": "https://feee.hcmute.edu.vn/TopicId/3da47dbc-8a7f-41d5-b930-6b465e06b3c6/tin-tuc"
        },
        "thong-bao": {
            "name": "Thông báo", 
            "url": "https://feee.hcmute.edu.vn/TopicId/91637dbd-2d06-44c6-b4be-983aed73b3b5/thong-bao"
        },
        "tieu-diem": {
            "name": "Tiêu điểm",
            "url": "https://feee.hcmute.edu.vn/TopicId/f0210bc1-15ee-4206-8469-b9b9ebe311ce/tieu-diem"
        }
    }
    ...
    async def save(self, articles, output_file="crawl/output/feee_output/articles.json"):
        import os
        import json
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="FEEE.HCMUTE Crawler")
    parser.add_argument("-c", "--category", 
                       choices=['tin-tuc', 'thong-bao', 'tieu-diem', 'all'],
                       default='all')
