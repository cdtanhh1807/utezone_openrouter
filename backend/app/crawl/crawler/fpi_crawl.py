...
from crawl.importdata.fpi.fpi_import import import_single_article
...
class FPIPlaywrightCrawler:
    BASE_URL = "https://fpi.hcmute.edu.vn"
    
    CATEGORIES = {
        "su-kien": {
            "name": "Sự kiện",
            "url": "https://fpi.hcmute.edu.vn/TopicId/0f0a888d-4786-4a0d-ba21-cc396ef3f1b4/tin-tuc-su-kien"
        },
        "thong-bao": {
            "name": "Thông báo", 
            "url": "https://fpi.hcmute.edu.vn/TopicId/a89f7a62-70f2-4a95-8d98-decbcf8f2996/thong-bao"
        },
        "tuyen-sinh": {
            "name": "Tuyển sinh",
            "url": "https://fpi.hcmute.edu.vn/TopicId/00bcab66-5cd4-477c-bd04-ee26e8034760/thong-tin-tuyen-sinh"
        }
    }
    ...
    async def save(self, articles, output_file="crawl/output/fpi_output/articles.json"):
        import os
        import json
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="FPI.HCMUTE Crawler")
    parser.add_argument("-c", "--category", 
                       choices=['su-kien', 'thong-bao', 'tuyen-sinh', 'all'],
                       default='all')
