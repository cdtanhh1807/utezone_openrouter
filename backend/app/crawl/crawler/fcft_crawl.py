...
from crawl.importdata.fcft.fcft_import import import_single_article
...
class FCFTPlaywrightCrawler:
    BASE_URL = "https://fcft.hcmute.edu.vn"
    
    CATEGORIES = {
        "hoat-dong": {
            "name": "Hoạt động",
            "url": "https://fcft.hcmute.edu.vn/TopicId/65e32f4c-f69e-4ddf-98ef-e846582bb024/hoat-dong-noi-bat"
        },
        "thong-bao": {
            "name": "Thông báo", 
            "url": "https://fcft.hcmute.edu.vn/TopicId/9122b988-43a5-44bc-ba4c-be415d93eaa4/thong-bao-sinh-vien"
        },
        "tuyen-dung": {
            "name": "Tuyển dụng",
            "url": "https://fcft.hcmute.edu.vn/TopicId/985aac1b-1f81-49aa-b24f-b1092f6ff350/hoc-bong-tuyen-dung"
        }
    }
    ...
    async def save(self, articles, output_file="crawl/output/fcft_output/articles.json"):
        import os
        import json
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="FCFT.HCMUTE Crawler")
    parser.add_argument("-c", "--category", 
                       choices=['hoat-dong', 'thong-bao', 'tuyen-dung', 'all'],
                       default='all')
