...
from crawl.importdata.fas.fas_import import import_single_article
...
class FASPlaywrightCrawler:
    BASE_URL = "https://fas.hcmute.edu.vn"
    
    CATEGORIES = {
        "tin-tuc": {
            "name": "Tin tức",
            "url": "https://fas.hcmute.edu.vn/TopicId/76d49102-7e51-4528-980c-3b2b0f900e99/tin-hoat-dong"
        },
        "thong-bao": {
            "name": "Thông báo", 
            "url": "https://fas.hcmute.edu.vn/TopicId/b72aec48-fc3b-4e91-9afc-e6f7db258bc8/thong-bao"
        },
        "de-thi": {
            "name": "Đề thi",
            "url": "https://fas.hcmute.edu.vn/TopicId/2ceefd16-3c07-4933-9bec-7f8a79cfb766/de-thi-dap-an"
        }
    }
    ...
    async def save(self, articles, output_file="crawl/output/fas_output/articles.json"):
        import os
        import json
...
async def main():
    ...
    parser.add_argument("-c", "--category", 
                       choices=['tin-tuc', 'thong-bao', 'de-thi', 'all'],
                       default='all')
