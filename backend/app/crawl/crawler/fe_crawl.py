...
from crawl.importdata.fe.fe_import import import_single_article
...
class FEPlaywrightCrawler:
    BASE_URL = "https://fe.hcmute.edu.vn"
    
    CATEGORIES = {
        "hoat-dong": {
            "name": "Hoạt động",
            "url": "https://fe.hcmute.edu.vn/TopicId/9036b229-bc66-4eac-97f5-28398dff7431/hoat-dong-noi-bat"
        },
        "hoi-thao": {
            "name": "Hội thảo", 
            "url": "https://fe.hcmute.edu.vn/TopicId/358e0bf9-a9e1-4e6c-9c8f-af9cbbe45dd2/hoi-thao-chuyen-de"
        },
        "tuyen-dung": {
            "name": "Tuyển dụng",
            "url": "https://fe.hcmute.edu.vn/TopicId/1c3b618c-5b18-4685-be3d-4b89052cfc95/tuyen-dung"
        }
    }
    ...
    async def save(self, articles, output_file="crawl/output/fe_output/articles.json"):
        import os
        import json
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="FE.HCMUTE Crawler")
    parser.add_argument("-c", "--category", 
                       choices=['hoat-dong', 'hoi-thao', 'tuyen-dung', 'all'],
                       default='all')
