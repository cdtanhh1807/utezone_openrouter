...
from crawl.importdata.feet.feet_import import import_single_article
...
class FEETPlaywrightCrawler:
    BASE_URL = "https://feet.hcmute.edu.vn"
    
    CATEGORIES = {
        "tin-tuc": {
            "name": "Tin tức",
            "url": "https://feet.hcmute.edu.vn/TopicId/faca9a35-2123-40f5-9505-26880e166786/tin-tuc"
        },
        "thong-bao": {
            "name": "Thông báo", 
            "url": "https://feet.hcmute.edu.vn/TopicId/490a0162-ee34-4e34-8374-17f3272270d6/thong-bao"
        },
        "viec-lam": {
            "name": "Học bổng việc làm",
            "url": "https://feet.hcmute.edu.vn/TopicId/9a7322f4-ce6d-41bf-b896-6f8a883090d4/hoc-bong-viec-lam"
        }
    }
    ...
    async def save(self, articles, output_file="crawl/output/feet_output/articles.json"):
        import os
        import json
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="FEET.HCMUTE Crawler")
    parser.add_argument("-c", "--category", 
                       choices=['tin-tuc', 'thong-bao', 'viec-lam', 'all'],
                       default='all')
