...
from crawl.importdata.fgtfd.fgtfd_import import import_single_article
...
class FGTFDPlaywrightCrawler:
    BASE_URL = "https://fgtfd.hcmute.edu.vn"
    
    CATEGORIES = {
        "sinh-hoat": {
            "name": "Sinh hoạt",
            "url": "https://fgtfd.hcmute.edu.vn/TopicId/7eb8f39c-e224-4e97-a9c9-b47b4d5fe7ab/sinh-hoat-hoc-thuat"
        },
        "thong-bao": {
            "name": "Thông báo", 
            "url": "https://fgtfd.hcmute.edu.vn/TopicId/d7021592-a9f4-4a64-b385-1dec9fa1997f/ban-tin-thong-bao"
        },
        "tuyen-dung": {
            "name": "Tuyển dụng",
            "url": "https://fgtfd.hcmute.edu.vn/TopicId/df5c997e-127c-46c7-967b-a747098f6a88/tin-tuyen-dung"
        }
    }
    ...
    async def save(self, articles, output_file="crawl/output/fgtfd_output/articles.json"):
        import os
        import json
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="FGTFD.HCMUTE Crawler")
    parser.add_argument("-c", "--category", 
                       choices=['sinh-hoat', 'thong-bao', 'tuyen-dung', 'all'],
                       default='all')
    ...
    crawler = FGTFDPlaywrightCrawler(
