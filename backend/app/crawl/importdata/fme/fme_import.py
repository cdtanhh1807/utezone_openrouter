...
async def fme_import():
    url = "http://localhost:8000/fme_crawl/crawl_import/import_single"
...
############
async def import_single_article(data_crawl: Dict[str, Any], api_url: str = "http://localhost:8000/fme_crawl/crawl_import/import_single") -> Tuple[bool, Dict]:
